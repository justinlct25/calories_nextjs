...
import DonorPersonalDetail from "./DonorPersonlDetail";


interface DonorInfoPageProps {
    donorInfo: any;
    iconUrl: string;
    bgImgUrl: string;
}

const DonorInfoPage: React.FC<DonorInfoPageProps> = ({ donorInfo, iconUrl, bgImgUrl }) => {
